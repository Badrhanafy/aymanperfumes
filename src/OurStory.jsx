  ...
  return (
    <div className="bg-white min-h-screen pt-[72px] md:pt-[88px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-3">
              ...
              <span className="text-[10px] md:text-xs uppercase tracking-[0.3em] text-neutral-500 font-medium">The Beginning</span>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -left-8 w-48 h-48 bg-neutral-100 rounded-2xl -z-10 opacity-60"></div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-black py-20 md:py-32 text-white overflow-hidden relative">
        <div className="absolute top-0 right-0 w-[50%] h-full bg-white/5 -skew-x-12 translate-x-1/4"></div>
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 text-center">
          <h3 className="text-2xl md:text-3xl font-serif mb-16 opacity-90">Our Core Philosophy</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
            <div className="space-y-4">
              <span className="text-4xl font-serif text-white/40">01</span>
            ...
            <div className="space-y-4">
              <span className="text-4xl font-serif text-white/40">02</span>
            ...
            <div className="space-y-4">
              <span className="text-4xl font-serif text-white/40">03</span>
      ...
      {/* Quote Section */}
      <section className="py-20 md:py-32 bg-neutral-50 text-center px-6">
        <div className="max-w-3xl mx-auto">
          <svg className="w-12 h-12 text-neutral-300/30 mx-auto mb-8" fill="currentColor" viewBox="0 0 24 24">
            <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
          </svg>
          <blockquote className="text-2xl md:text-4xl font-serif text-black leading-snug mb-8">
            "A perfume is more than just a scent; it is a signature that speaks when you are silent."
          </blockquote>
          <cite className="text-xs uppercase tracking-[0.3em] text-neutral-500 font-medium not-italic">— Master Perfumer, L'ESSENCE</cite>
        </div>
      </section>
